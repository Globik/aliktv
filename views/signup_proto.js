const { promo_token, one_token_btc } = require('../config/app.json');
...
<div class="inwrap3"><label><strong>Промокод / Promo code <small>- получите ${promo_token} токенов (${(promo_token/2)*one_token_btc} BTC) в подарок</small></strong></label></div>
